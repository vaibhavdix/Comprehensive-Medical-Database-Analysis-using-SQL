...
ADD hospital_charges float;
UPDATE MedicalRecords 
SET hospital_charges='113.88'
WHERE patient_id=1;
UPDATE MedicalRecords 
SET hospital_charges='166.95'
WHERE patient_id=2;
UPDATE MedicalRecords 
SET hospital_charges='10.14'
WHERE patient_id=3;
UPDATE MedicalRecords 
SET hospital_charges='220.60'
WHERE patient_id=4;
UPDATE MedicalRecords 
SET hospital_charges='25.63'
WHERE patient_id=5;
UPDATE MedicalRecords 
SET hospital_charges='36.07'
WHERE patient_id=6;
UPDATE MedicalRecords 
SET hospital_charges='14.90'
WHERE patient_id=7;
UPDATE MedicalRecords 
SET hospital_charges='13.11'
WHERE patient_id=8;
UPDATE MedicalRecords 
SET hospital_charges='4.27'
WHERE patient_id=9;
UPDATE MedicalRecords 
SET hospital_charges='3.27'
WHERE patient_id=10;
UPDATE MedicalRecords 
SET hospital_charges='3.57'
WHERE patient_id=11;
UPDATE MedicalRecords 
SET hospital_charges='23.63'
WHERE patient_id=12;
UPDATE MedicalRecords 
SET hospital_charges='35.77'
WHERE patient_id=13;
UPDATE MedicalRecords 
SET hospital_charges='102.41'
WHERE patient_id=14;
UPDATE MedicalRecords 
SET hospital_charges='3.57'
WHERE patient_id=15;
UPDATE MedicalRecords 
SET hospital_charges='1.49'
WHERE patient_id=16;
UPDATE MedicalRecords 
SET hospital_charges='3.75'
WHERE patient_id=17;
UPDATE MedicalRecords 
SET hospital_charges='6.55'
WHERE patient_id=18;
UPDATE MedicalRecords 
SET hospital_charges='35.77'
WHERE patient_id=19;
UPDATE MedicalRecords 
SET hospital_charges='32.79'
WHERE patient_id=20;
